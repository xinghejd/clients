...
import { CliCryptoFunctionService } from "./cli-crypto-function.service";

describe("Cli Crypto Function Service", () => {
  describe("argon2", () => {
...
function testArgon2(regularKey: string, utf8Key: string, unicodeKey: string) {
  ...
  it("should create valid key from regular input", async () => {
    const cryptoFunctionService = new CliCryptoFunctionService();
