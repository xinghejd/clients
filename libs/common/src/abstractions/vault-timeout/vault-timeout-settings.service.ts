...
export abstract class VaultTimeoutSettingsService {
   ...
   */
  abstract getVaultTimeout(userId?: string): Promise<number>;
   ...
   * @param userId The user id to check. If not provided, the current user is used
   */
  abstract vaultTimeoutAction$(userId?: string): Observable<VaultTimeoutAction>;
   ...
   * @returns PinLockType
   */
  abstract isPinLockSet(userId?: string): Promise<PinLockType>;
