...
import { FactorUsernameGeneratorSettingsMigrator } from "./migrations/10-factor-username-generator-settings";
...
export async function migrate(
  ...
  MigrationBuilder.create()
    ...
    .with(FactorUsernameGeneratorSettingsMigrator, 9, CURRENT_VERSION)
