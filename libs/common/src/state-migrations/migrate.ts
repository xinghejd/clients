...
import { UserNotificationSettingsKeyMigrator } from "./migrations/26-move-user-notification-settings-to-state-provider";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(UserNotificationSettingsKeyMigrator, 25, CURRENT_VERSION);
}
