...
import { MoveDesktopBiometricStateToProviders } from "./migrations/13-move-desktop-biometric-state-to-providers";
...
export async function migrate(
  ...
  MigrationBuilder.create()
    ...
    .with(MoveDesktopBiometricStateToProviders, 12, CURRENT_VERSION)
