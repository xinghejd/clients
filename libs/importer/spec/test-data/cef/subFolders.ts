...
const subFolders: CredentialExchangeFormat = {
  version: 1,
  exporter: "Nordpass",
          ...
          subCollections: [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  modifiedAt: 1709279117,
                  type: "login",
                  title: "Login with all custom fields2",
                  credentials: [
                    {
                      type: "basic-auth",
                      urls: [
...
export const subFoldersString = JSON.stringify(subFolders);
